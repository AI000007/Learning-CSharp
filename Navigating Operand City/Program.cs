...
BlockCoordinate a  = new BlockCoordinate(1, 3);

Console.WriteLine(a + Direction.South);
Console.WriteLine(a + new BlockOffset(3, 3));
...
public record BlockCoordinate(int Row, int Column)
{
    ...
    public static BlockCoordinate operator +(BlockCoordinate a, Direction b) => b switch
    {
    ...
    public int this[int i]
    {
        get
        {
            if (i == 0) return Row; return Column;
        }
    }
}
public record BlockOffset(int RowOffset, int ColumnOffset)
{
    public static implicit operator BlockOffset(Direction a) => a switch
    {
